...
- La elegida tiene el menor D (0.0111 m²/s) y el menor ⟨t90⟩ (18.28 s). El disco queda en el medio en las dos (0.0122 m²/s y 19.77 s).
- El embudo tiene más difusión que la mesa vacía (0.0188 contra 0.0169 m²/s) y un ⟨t90⟩ al lado (20.98 s contra 21.11 s).
- Las barras se solapan, también entre la elegida y la mesa vacía: 2.83 s de diferencia de medias, con desvíos de 1.74 s y 2.45 s.

## Notas y conclusiones

- D es el de la ventana 0.5–1.5 s, semilla 401. ⟨t90⟩ es el de las semillas 401 a 412. Las 12 realizaciones de cada configuración llegan a Fu = 0.9.
- La elegida reúne el menor D y el menor ⟨t90⟩, y el disco queda en el medio. El embudo no: tiene más difusión que la mesa vacía y su ⟨t90⟩ cae dentro del desvío de esa mesa.
