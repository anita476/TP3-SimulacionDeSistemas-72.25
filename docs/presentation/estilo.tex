...
\newcommand{\siimagen}[3]{%  #1 ruta bajo data/ | #2 si está | #3 si no
  \IfFileExists{../data/#1}{#2}{\IfFileExists{figs/#1}{#2}{#3}}%
}

\newcommand{\figura}[2][\linewidth]{%
  \siimagen{#2}%
    {\includegraphics[width=#1,height=0.74\textheight,keepaspectratio]{#2}}%
    {\framebox[#1][c]{\rule{0pt}{5cm}\textit{falta la figura}}}%
}
...
\newcommand{\animacion}[6]{%
  ...
  \else
    \siimagen{#5}%
      {\includegraphics[width=\linewidth,height=0.62\textheight,keepaspectratio]{#5}}%
      {\framebox[\linewidth][c]{\rule{0pt}{4.2cm}\textit{fotograma}}}%
